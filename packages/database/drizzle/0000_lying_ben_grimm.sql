CREATE TYPE "public"."project_role" AS ENUM('owner', 'editor', 'reviewer');--> statement-breakpoint
...
CREATE INDEX "screenplays_project_id_index" ON "screenplays" USING btree ("project_id");--> statement-breakpoint
