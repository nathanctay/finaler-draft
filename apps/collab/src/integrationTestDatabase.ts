...
// that would let both `apps/api` and `apps/collab` depend on one shared copy without adding a
// package for infrastructure this thin. See progress/collaboration-slice-1.md for the reasoning.
